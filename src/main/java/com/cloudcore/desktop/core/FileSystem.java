...
public class FileSystem {
    ...
    public static int[] getTotalCoinsValid() {
        return getTotalCoinsValid(RootPath);
    }
    public static int[] getTotalCoinsValid(String accountFolder) {
        ...
        totals[5] = bankTotals[0] + frackedTotals[0];
        totals[0] = bankTotals[1] + frackedTotals[1];
        totals[1] = bankTotals[2] + frackedTotals[2];
        totals[2] = bankTotals[3] + frackedTotals[3];
        totals[3] = bankTotals[4] + frackedTotals[4];
        totals[4] = bankTotals[5] + frackedTotals[5];

        return totals;
    }

    public static File fileChooser3() {
        ...
        PlatformImpl.startup(() -> {
            ...
            file.set(d.showOpenDialog(null));
    ...
    public static File fileChooser2() {
